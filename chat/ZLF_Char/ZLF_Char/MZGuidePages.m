...
- (void)initView
{
    ...
    _pageControl.pageIndicatorTintColor = [UIColor colorWithWhite:0.694 alpha:1.000];
...
- (void)initContentView
{
    if (_imageDatas.count)
    {
        ...
        for (int i = 0; i < _imageDatas.count; i++)
        {
            ...
            {
                _actionButton.frame =
                    CGRectMake(SCREEN_WIDTH / 2 - 70, SCREEN_HEIGHT - 90, 140, 35);
                _actionButton.layer.cornerRadius = 15;
                _actionButton.layer.masksToBounds = YES;
                [_actionButton setTitle:@"进入新世界" forState:UIControlStateNormal];
